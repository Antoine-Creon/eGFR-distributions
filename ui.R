      ...
      tabItem(tabName = "Calculator",
              fluidRow(
                ...
                box(
                  ...
                  selectInput("sex", "Sex:", choices = c("Male", "Female"), selected = "Female"),
                  numericInput("age", "Age:", value = 50, min = 40, max = 100),
                  numericInput("egfr", "eGFR:", value = 90, min = 10, max = 129),
                  selectInput("equation", "Equation:", choices = c("CKD-EPI 2009", "CKD-EPI 2021", "EKFC", "Revised Lund-Malmö"),
                              selected = "CKD-EPI 2021") #,
                  # actionButton("update", "Update Plot", class = "btn btn-primary")
                ),

                box(
                  title = "Population-based eGFR distribution", status = "primary", solidHeader = TRUE, width = 8,
                  plotOutput("Plot")
                ),

                box(
                  title = "eGFR Percentile and interpretation", status = "primary", solidHeader = TRUE, width = 12,
      ...
      tabItem(tabName = "about",
              fluidRow(
                ...
                box(title = "The team", status = "primary", solidHeader = TRUE, width = 12,
                    ...
                    tags$a(href = "https://ki.se/en/research/research-areas-centres-and-networks/research-groups/cardio-renal-epidemiology-juan-jesus-carreros-research-group?auHash=hhoISq-w5-ly2G1-qevFvi_lSMvpgmWlID4z8IesSCg#tab-start",
                           "Visit the JJ Carrero group webpage.",
                           target = "_blank")
                ),

                box(title = "Developper", status = "primary", solidHeader = TRUE, width = 12,
                    "Antoine Créon, Juan Jesus Carrero group at Karolinska Institutet.")
              )
      ),
      tabItem(tabName = "disclaimer",
              fluidRow(
                box(title = "Copyright", status = "warning", solidHeader = TRUE, width = 12,
...
\n
    ...
    along with this program.  If not, see https://www.gnu.org/licenses/."),
                ...
                box(title = "Limitations of liability", status = "warning", solidHeader = TRUE, width = 12,
                ...
                box(title = "Disclaimer", status = "warning", solidHeader = TRUE, width = 12,
                ...
                box(title = "Not medical advice", status = "warning", solidHeader = TRUE, width = 12,
